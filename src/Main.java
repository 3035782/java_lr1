...
public class Main {
    public static void main(String[] args) {
        ...
        String s_number = String.valueOf(number); // переводим число в строку, чтобы получить последний символ
        System.out.println(s_number.charAt(s_number.length() - 1)); // chatAt(n) - метод, который возвращаем символ в строке на n месте
        ...
        int result = 0;
        for (int i = 0; i < s_number.length(); i++) { // проходим от 0 до длины строки
